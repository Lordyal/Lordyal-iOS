...
extension Font {
    ...
    static func Body(size: CGFloat = 16, relativeTo: TextStyle = .caption) -> Font {
    ...
    static func Bold(size: CGFloat = 20, relativeTo: TextStyle = .title3) -> Font {
        Font.custom("OpenSans-Bold", size: size, relativeTo: relativeTo)
    }
    
    static func Title(size: CGFloat = 30, relativeTo: TextStyle = .title2) -> Font {
